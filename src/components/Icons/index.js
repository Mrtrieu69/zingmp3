...
export const SingleNote = ({ className }) => (
    <svg width="10" height="10" fill="#fff" viewBox="0 0 384 512" className={`${className} thumb-note note-4`}>
...
export const DoubleNote = ({ className }) => (
    <svg width="10" height="10" fill="#fff" viewBox="0 0 512 512" className={`${className} thumb-note note-1`}>
