const themes = {
    ...
    rose: {
        ...
        '--empty-album-icon': 'url("/images/empty/")',
        '--empty-podcast-icon': 'url("/images/empty/")',
        '--empty-song-icon': 'url("/images/empty/")',
        '--empty-upload-icon': 'url("/images/empty/")',
        '--empty-mv-icon': 'url("/images/empty/")',
    },
    dark: {
        '--hover-tooltip-opacity': 'hsla(0,0%,100%,0.3)',
        '--primary-bg': '#282828',
